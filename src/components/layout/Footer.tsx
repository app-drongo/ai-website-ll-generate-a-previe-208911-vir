...
const DEFAULT_FOOTER = {
  logoText: 'AccuFlow',
  companyDescription:
    'Streamline your accounting processes with our comprehensive SaaS platform. Trusted by over 10,000 businesses worldwide for automated bookkeeping, financial reporting, and tax compliance.',
  contactEmail: 'support@accuflow.com',
  ...
  newsletterDisclaimer: 'Get weekly accounting tips and product updates. Unsubscribe anytime.',
  section1Title: 'Platform',
  section2Title: 'Company',
  section3Title: 'Support',
  section4Title: 'Legal',
  copyrightText: '© 2024 AccuFlow. All rights reserved.',
  madeWithText: 'by financial experts',
  socialText: 'Connect with us:',
  social1Href: 'https://twitter.com/accuflow',
  social2Href: 'https://facebook.com/accuflow',
  social3Href: 'https://instagram.com/accuflow',
  social4Href: 'https://linkedin.com/company/accuflow',
  social5Href: 'https://github.com/accuflow',
} as const;
...
export default function Footer(props: FooterProps) {
  ...
  const footerSections = [
    ...
    },
    {
      ...
      links: [
        { name: 'About AccuFlow', href: '/about', editableId: 'link-footer-about' },
