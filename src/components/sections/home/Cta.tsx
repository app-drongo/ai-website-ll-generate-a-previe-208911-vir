...
const DEFAULT_CTA = {
  ...
  description:
    'Join over 50,000 small business owners who trust our AI-powered accounting platform to save time, reduce errors, and maximize their profits. Start your free trial today.',
  ...
  stat1Value: '50K+',
  stat1Label: 'Business Owners',
  stat2Value: '15 hrs',
  stat2Label: 'Saved Weekly',
  stat3Value: '99.8%',
  stat3Label: 'Accuracy Rate',
  stat4Value: '24/7',
  stat4Label: 'Expert Support',
  feature1Title: 'No Credit Card',
  feature1Description: 'Full 30-day trial with all premium features',
