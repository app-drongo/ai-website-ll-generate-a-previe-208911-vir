...
const DEFAULT_CONTACT = {
  ...
  mainDescription:
    'Join thousands of small businesses who trust our accounting platform. Get personalized support and start streamlining your financial operations today.',
  formTitle: 'Request a Free Demo',
  formDescription:
    "See how our accounting software can save you time and money. We'll customize a demo based on your business needs.",
  ...
  method1Contact: 'support@accountingpro.com',
  ...
  office1Address: '2500 Business Center Dr, Suite 200',
  office1Timezone: 'CST (UTC-6)',
  office2City: 'Denver, CO',
  office2Address: '1800 Financial Plaza, Floor 12',
  office2Timezone: 'MST (UTC-7)',
  office3City: 'Atlanta, GA',
  office3Address: '3200 Peachtree Road, Building C',
  office3Timezone: 'EST (UTC-5)',
  hoursTitle: 'Support Hours',
  hoursWeekdayLabel: 'Monday - Friday',
  hoursWeekdayTime: '8:00 AM - 7:00 PM EST',
  hoursSaturdayLabel: 'Saturday',
  hoursSaturdayTime: '10:00 AM - 3:00 PM EST',
  ...
  messagePlaceholder:
    'Describe your current accounting challenges, number of employees, monthly transactions, etc...',
} as const;
